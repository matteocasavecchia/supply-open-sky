...
report a possible violation, send an email to
[matteo.casavecchia+sos-conduct@gmail.com](mailto:matteo.casavecchia+sos-conduct@gmail.com).**

Reports are reviewed by the project maintainers, who will make every effort
to respond in a timely manner. Investigations may include reviewing
messages, logs, or recordings, and interviewing witnesses or other
participants. Investigations and enforcement actions are kept as transparent
as possible while prioritizing the safety and confidentiality of the people
involved. Enforcement actions are carried out in private with the involved
parties; communicating to the wider community may be part of a mutually
...
3. **Temporary Suspension**
   1. *Event:* A pattern of repeated violation which the project maintainers
...
4. **Permanent Ban**
   1. *Event:* A pattern of repeated code of conduct violations that other
      ...
      that the project maintainers determine there is no way to keep the
      community safe with this person as a member.
   2. *Consequence:* Access to all community spaces, tools, and
      communication channels is removed. In general, permanent bans should
      be rarely used, should have strong reasoning behind them, and should
      only be resorted to if working through other remedies has failed to
      change the behavior.
   3. *Repair:* There is no possible repair in cases of this severity.

This enforcement ladder is intended as a guideline. It does not limit the
ability of the project maintainers to use their discretion and judgment, in
...
<https://www.contributor-covenant.org/translations>. The enforcement ladder
